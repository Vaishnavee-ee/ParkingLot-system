...
public class parkinglot1 {
   ...
   // ImageIcon backgroundIcon = new ImageIcon("assetslot/parkinglotpic.png");
   ...
   frame.setContentPane(layeredPane); // optional, if you're using layeredPane
...
//container.setBackground(Color.DARK_GREEN);
    ...
    icon = new ImageIcon("assetslot/car_top_1.png"); // fallback car image
}
...
class Vehicle {
    ...
    Vehicle(String plate, String type, int slot, int imageIndex) {
      ...
      // this.imageIndex = (imageIndex == -1) ? new Random().nextInt(5) + 1 : imageIndex;
